...
const SignUp = () => {
  ...
  const { email, name, username, password, isGuide } = user;
  ...
  const handleDataChange = (e) => {
    ...
    } else if (e.target.name === "isGuide") {
      setUser((prevUser) => ({ ...prevUser, isGuide: e.target.checked }));
    } else {
      ...
      <Auth>
        <div className="bg-white border flex flex-col gap-2 p-4 pt-10">
          <img
            ...
            alt=""
          />
          <h2 className="text-center">WonderMingle</h2>
          <form
